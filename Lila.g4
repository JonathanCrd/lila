...
especiales
    ...
    | QUICKSHOW OPEN_PARENTHESIS ID {Semantic.checkIsOneDim($ID.text)} {gen.q_basics($ID.text,'QUICKSHOW')} (COMMA ID {Semantic.checkIsOneDim($ID.text)} {gen.q_basics($ID.text,'QUICKPARAM')})? CLOSE_PARENTHESIS SEMICOLON
